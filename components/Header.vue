    ...
    <div>
        ...
        <div class="d-flex">
            <div v-if="isSearchBarVisible" class="search-bar">
                <div class="header-section">
                    ...
                    <button class="close-button"><i class="fa fa-search"
                            style="font-size: 20px; padding: 8px;"></i></button>
                    <button class="close-button" @click="toggleSearchBar"><i class="fa fa-xmark"
                            style="font-size: 20px; padding: 8px;"></i></button>
            ...
            <div :class="{ 'hidden': isSearchBarVisible }">
        ...
        <header class="d-none d-lg-block">
            ...
            <div class="text-white d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center py-1 col-5 justify-content-end" id="one"
                    style="background-color: #E52727; padding-right: 180px;">
                    <a href="tel:9425311328" class="text-white" style="font-size: 16px;"><i
                            class="fa fa-phone mr-2"></i>Call Us: +91
                        94253, 11328</a>
                </div>
                <div style="background-color: white; " class="py-1 px- text-center col-2">
                    <small class="text-muted " style="background-color: white; font-weight: 600; font-size: 14px;">
                        Auto parts for Cars, trucks and motorcycles</small>
                </div>

                <div class="d-flex align-items-center py-1 col-5" id="two"
                    style="background-color: #333333; padding-left: 120px; align-items: center;">
                    <div class="text-white ml-3 " style="font-size: 16px;"><i class="fa fa-envelope mr-2"></i>Email:
                        <a href="mailto:support@advanceengineerings.com" class="text-white "
                            style="font-size: 16px;">support@advanceengineerings.com</a>
                        / <a href="mailto:sales@advanceengineerings.com" class="text-white "
                            style="font-size: 16px;">sales@advanceengineerings.com</a>
                    </div>
                </div>
            </div>
            ...
            <div style="position: relative;" class="">
                <header class="align-items-center py-0  border-bottom bg-white d-flex justify-content-between ">
                    ...
                    <div class="text-center col-lg-4 my-3">
                        <a href="/"><img width="110" src="/images/logo/ad.jpg" alt=""></a>
                    </div>
                    ...
                    <div v-else class="d-flex align-items-center col-lg-4 my-2">
                        ...
                        <button @click="doLogout()" v-if="token" type="submit" class="btn btn-danger mx-2"
                            style="font-weight: 600;"> Logout
...
.hidden {
    display: none;
    /* Hide the main content when search bar is visible */
}
...
/* Adjust sidebar for mobile responsiveness */
...
#one {
    clip-path: polygon(0% 0, 100% 0, 100% 0%, 96.5% 100%, 0 100%, 0 100%);
    border: none;
    width: 194px;
    height: 36px;
}
...
#two {
    clip-path: polygon(0% 0, 100% 0, 100% 100%, 3.5% 100%, 0 0%, 0 100%);
    border: none;
    width: 194px;
    height: 36px;
}
...
.search__shadow:before {
    ...
    position: relative;
    top: 100%;
    box-shadow: 0 -1px 4px rgba(0, 0, 0, .32), 0 -1px rgba(0, 0, 0, .02);
    border-radius: 120px/10px
}
