            ...
            <div ref="featuredSlider" class="keen-slider">
                ...
                :id="featured.p_id" :name="featured.p_name" :image="featured.p_image" /> -->
                        ...
                        <div class="product-card product-card--layout--grid pb-2 "
                            style="box-shadow: 0 2px 8px -1px rgb(0 0 0 / 0.1), 0 2px 4px -2px rgb(0 0 0 / 0.1);">
                        ...
                        <img class="image__tag" :src="image" alt="Hello">
                                        ...
                                        <div class="image__body">
                                            <img class="image__tag" src="https://red-parts.html.themeforest.scompiler.ru/themes/red-ltr/images/posts/post-5-730x485.jpg" alt="Hello">
                                        </div>
                                    </div>
                                </div>
                            </div>
