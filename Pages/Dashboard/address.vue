							...
							<div class="addresses-list"><a href="#"
								...
								<div class="addresses-list__item card address-card">
									...
									<div class="address-card__body">
										...
										<div class="address-card__footer"><a href="#" style="color: #cb1818;">Edit</a>&nbsp;&nbsp; <a
												href="#" style="color: #cb1818;">Remove</a></div>
									</div>
								</div>
								<div class="addresses-list__divider"></div>
								<div class="addresses-list__item card address-card">
									<div class="address-card__body">
										...
										<div class="address-card__footer" >
                                            <a href="#" style="color: #cb1818;">Edit</a>&nbsp;&nbsp; <a
												href="#" style="color: #cb1818;">Remove</a>
                                        </div>
									</div>
								</div>
								<div class="addresses-list__divider"></div>
