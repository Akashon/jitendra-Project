  ...
  <div class="site__body">
	...
	c-3.9,0-7,3.1-7,7s3.1,7,7,7s7-3.1,7-7S18.9,2,15,2z M16,13h-2v-3h-3V8h3V5h2v3h3v2h-3V13z" />
                    ...
                    <div class="owl-carousel">
                      ...
                      <a class="image image--type--product" href="https://picsum.photos/id/1/700/700" target="_blank"
                        data-width="700" data-height="700">
                        <div class="image__body"><img class="image__tag" src="https://picsum.photos/id/1/500/500"
                            alt=""></div>
                      </a>
                  ...
                  <div class="product-gallery__thumbnails">
                    <div class="owl-carousel">
                      <div class="product-gallery__thumbnails-item image image--type--product">
                        <div class="image__body"><img class="image__tag" src="https://picsum.photos/id/1/70/70" alt="">
                        </div>
                      </div>
                      <div class="product-gallery__thumbnails-item image image--type--product">
                        <div class="image__body"><img class="image__tag" src="https://picsum.photos/id/2/70/70" alt="">
                        </div>
                      </div>
                      <div class="product-gallery__thumbnails-item image image--type--product">
                        <div class="image__body"><img class="image__tag" src="https://picsum.photos/id/3/70/70" alt="">
                        </div>
                      </div>
                      <div class="product-gallery__thumbnails-item image image--type--product">
                        <div class="image__body"><img class="image__tag" src="https://picsum.photos/id/4/70/70" alt="">
                        </div>
                      </div>
                    </div>
                  </div>
                          ...
                          <div class="product-form__control">
                            <div class="input-radio-label">
                              <div class="input-radio-label__list"><label class="input-radio-label__item"><input
                                ...
                                <label class="input-radio-label__item"><input type="radio" name="material"
                    ...
                    <div class="product__tags-and-share-links">
                      <div class="product__tags tags tags--sm">
                        <div class="tags__list"><a href="#">Brake Kit</a> <a href="#">Brandix</a> <a href="#">Filter</a>
                          <a href="#">Bumper</a> <a href="#">Transmission</a> <a href="#">Hood</a>
                        </div>
                      </div>
                              ...
                              <li class="reviews-list__item">
                                <div class="review">
                                  <div class="review__body">
                                    <div class="review__avatar"><img src="https://picsum.photos/id/1/42/42" alt="">
                                    </div>
                            ...
                            <div class="col-xxl-8 col-xl-10 col-lg-9 col-12">
                              <div class="form-row">
                                ...
                                <div class="form-group col-md-4"><label for="review-author">Your Name</label> <input
                                    type="text" class="form-control" id="review-author" placeholder="Your Name">
                                </div>
                              ...
                              <div class="form-group"><label for="review-text">Your
                                  Review</label> <textarea class="form-control" id="review-text" rows="6"></textarea>
                              </div>
                              <div class="form-group mb-0 mt-4"><button type="submit" class="btn btn-primary">Post Your
                                  Review</button></div>
                            </div>
                          </div>
                        </form>
  ...
  <div class="block-split__item block-split__item-content col-auto">
    <div class="product product--layout--full">
      <div class="product__body">
          ...
          <div class="product-gallery__featured">
            ...
            <div class="product-gallery" v-if="images.length">
              <div class="text-center mb-2 position-relative border-sm">
                <img :src="images[activeIndex].large" class="img-fluid" style="max-height: 400px;" alt="Main Image" />
                <button class="btn btn-light position-absolute " style="top: 10px; right: 2px; border-radius: 10%;"
                  @click="zoomImage">
              ...
              <div class="d-flex justify-content-between mb-3">
                <button class=" btn-outline-danger rounded" @click="prevImage" :disabled="activeIndex === 0"><i
                    class="fa fa-chevron-left"></i></button>
                <button class=" btn-outline-danger rounded" @click="nextImage"
                  :disabled="activeIndex === images.length - 1"><i class="fa fa-chevron-right"></i></button>
              </div>
        ...
        <!-- IMAGE SECTION END -->
        <div class="product__header">
          <h1 class="product__title">THIS IS PRODUCT NAME</h1>
          <div class="product__subtitle">
            <div
              class="status-badge status-badge--style--success product__fit status-badge--has-icon status-badge--has-text">
              <div class="status-badge__body">
        ...
        <div class="product__main">
          <div class="product__excerpt">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nobis ex aut ea qui
            odio ut nisi sed voluptatibus cum quidem, at doloremque? Odit voluptas sequi minus quasi fugit at in.
          </div>
          <div class="product__features">
            <div class="product__features-title">Key Features:</div>
            <ul>
        ...
        <div class="product__tabs product-tabs product-tabs--layout--full">
          <ul class="nav nav-tabs product-tabs__list" role="tablist">
            <li class="product-tabs__item " :class="{ 'product-tabs__item--active': activeTab === 'tabs-1' }"><a
          ...
          <div class="tab-content">
            <div class="tab-pane p-3" :class="{ active: activeTab === 'tabs-1' }" id="tabs-1" role="tabpanel">
              <p>{{ discription }}</p>
            </div>
            <div class="tab-pane p-3" :class="{ active: activeTab === 'tabs-2' }" id="tabs-2" role="tabpanel">
              <p>Second Panel</p>
            </div>
          </div>
        </div>
...
<template>
  <div class="product-gallery" v-if="images.length">
    <div class="text-center mb-3 position-relative">
      <img :src="images[activeIndex].large" class="img-fluid" style="max-height: 400px;" alt="Main Image" />
      <button class="btn btn-light position-absolute" style="top: 10px; right: 10px" @click="zoomImage">
        🔍
      </button>
    </div>

    <div class="d-flex justify-content-between mb-3">
      <button class="btn btn-outline-primary" @click="prevImage" :disabled="activeIndex === 0">Prev</button>
      <button class="btn btn-outline-primary" @click="nextImage" :disabled="activeIndex === images.length - 1">Next</button>
    </div>
    ...
    <div class="d-flex justify-content-center flex-wrap">
      <div
        ...
        :key="index"
        class="mx-1"
        :class="{ 'border border-primary': activeIndex === index }"
